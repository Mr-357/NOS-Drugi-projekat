...
#define HTTP_HOST "116.202.13.157"
...
#define HTTP_PATH "/hello"


#define SSTRLEN(s) (sizeof(s) - 1)
#define CHECK(r) { if (r == -1) { printf("Error: " #r "\n error:%d",errno); exit(1); } }

#define REQUEST "POST " HTTP_PATH " HTTP/1.1\r\nHost: " HTTP_HOST "Content-Type: text/plain\r\nContent-Length: 1\r\n\r\n4\r\n"
...
void main(void)
{
	...
	printf("Preparing HTTP request for http://" HTTP_HOST
	       ":" HTTP_PORT HTTP_PATH "\n");
